  ...
  return (
    <AntdConfigProvider>
      <main className="flex relative min-h-screen flex-col items-center bg-slate-950 text-gray-300">
        ...
        <div className="flex flex-col p-4 border border-3 border-gray-600 rounded-lg z-10 opacity-95">
        ...
        <div className="flex flex-row gap-2.5 z-10 text-xs font-light mt-2">
